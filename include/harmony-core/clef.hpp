...
namespace harmony_core {
    ...
    public:
        ...
        /*!
         * \brief Данная функция возвращает расположение ноты на нотном стане от 0-й линии нотного стана снизу.
         *
         ...
         *
         * Положительное число (начиная с нуля) - колличество линейки вверх
         * (если число больше 5 то остаток от вычитания 5 является колличеством добавочнх линеек сверху).
         */
        [[nodiscard]] float get_place(Note note) const noexcept;

        /*!
         * \brief Данная функция возвращает ноту, расположенную на указанной линейке текущего ключа.
