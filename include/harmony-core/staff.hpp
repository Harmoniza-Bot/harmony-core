...
namespace harmony_core {
    ...
    public:
         ...
         * Если имеется две и более ноты с одинаковым индексом, то такт можно обозначить на любой из них.
         * Важный момено - индексация нот здесь начинается с первой ноты (не с нулевой!).
         */
         ...
         * то функция назобъет ее на две половинки
         * и добавит тактовые черты после необходимых нот.
         */
        void fix_err() noexcept;
