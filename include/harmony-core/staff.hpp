...
namespace harmony_core {
    ...
    public:
         ...
         * Аргумент add_tie(1) добавит в индекс первую ноту.
         * Аргумент add_tie(3) Добавит в индекс третью ноту.
         *
         * То есть tie_index будет хранить {1, 3}, то есть те ноты, которые необходимо залиговать
         *
         * Не имеет значения, где в стане эта нота расположена
         * (то есть не важен второй элемент пары).
         */
