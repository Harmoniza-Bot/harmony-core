...
namespace harmony_core {
    ...
    enum class Duration {
        ...
        EIGHTH = 0b100,
        /*!
         * \brief Представляет собой шестнадцатую часть длительности целой ноты.
         */
        SIXTEENTH = 0b101,
        /*!
        ...
        THIRTY_SECOND = 0b110,
        /*!
         * \brief Представляет собой шестьдесят четвертую часть длительности целой ноты.
         */
        SIXTY_FOURTH = 0b111
    };
    ...
    enum class Clef_name {
        ...
        /*!
         * \brief Представляет французский скрипичный ключ
         */
        FRENCH_VIOLIN = 0b0010,

        /*!
         * \brief Представляет скрипичный ключ
         */
        TREBLE = 0b0011,

        /*!
         * \brief Представляет Сопрановый ключ
         */
        SOPRANO = 0b0100,

        /*!
         * \brief Представляет Меццо сопрановый ключ
         */
        MEZZO_SOPRANO = 0b0101,

        /*!
         * \brief Представляет Альтовый ключ
         */
        ALTO = 0b0110,

        /*!
         * \brief Представляет Теноровый ключ
         */
        TENOR = 0b0111,

        /*!
         * \brief Представляет Баритоновый ключ
         */
        BARITONE = 0b1000,

        /*!
         * \brief Представляет Басовый ключ
         */
        BASS = 0b1001,

        /*!
         * \brief Представляет суб басовый ключ
         */
        SUBBASS = 0b1010,

        /*!
         * \brief Представляет ключ для табулатуры
         */
        TABULATURE = 0b1011
    };
    ...
    enum class Function {
        ...
        */
        ...
        /*!
        Представляет тоническую функцию
        */
        T = 0b001,

        /*!
        Представляет функциб второй ступени.
        Является родственником субдоминанты.
        */
        Sp = 0b010,

        /*!
        Представляет функцию 3 ступени.
        Является родственником доминанты и антиродсивенником тоники.
        */
        Dp = 0b011,

        /*!
        Представляет функцию субдоминанты
        */
        S = 0b100,

        /*!
        Представляет функцию доминанты
        */
        D = 0b101,

        /*!
        Представляет функцию 6 ступени.
        Является родственником тоники.
        */
        Tp = 0b110,

        /*!
        Представляет функцию 7 ступени.
        Ещё называется незаконченной доминантой.
        */
        D7 = 0b111
    };
} // namespace harmony_core
